...
<body>
     ...
     <div class="twelve columns">
      ...
      <div class="show-for-large-up"><!-- Slider -->
        <div class="row">

            <div id="featured"><img src="images/demo1.jpg" alt="desc" /> <img src="images/demo2.jpg" alt="desc" /> <img src="images/demo3.jpg" alt="desc" /></div>
      ...
      <div class="heading_dots hide-for-small"><h1 class="heading_supersize"><span class="heading_center_bg">PRIMJER 1</span></h1></div>
      
      <div class="twelve columns">
      
      

      <p class="welcome_text">Ovo je primjer 1 stranica</p> 
      <p style="text-align:center"><a href="onama.php" class="button large round">Find out more &raquo;</a> </p>
      ...
      <div class="row">
       ...
       <div class="heading_dots hide-for-small" style="margin-bottom:25px"><h1 class="heading_supersize"><span class="heading_center_bg">Meet The Team</span></h1></div>
      ...
      <div class="heading_dots hide-for-small"><h1 class="heading_supersize"><span class="heading_center_bg">Services &amp; Products</span></h1></div>
