			...
			<div class="large-8 medium-8 small-12 columns large-centered">
				<div class="callout">
					<div class="row">
						...
						<div class="large-6 medium-6 small-12 columns">
							<a href="unos.php" class="button expanded">DODAJ NOVU FUNKCIJU</a>
						</div>
					</div>
					<table class="hover unstriped">
						<thead>
							<tr>
								<th>Funkcija u vatrogastvu</th>
								<th>Akcija</th>
							</tr>
						</thead>				
						<tbody>
							...
							?>
							<tr>
								<td data-label="Funkcija u vatrogastvu"><?php echo $red->naziv_funkcije; ?></td>
