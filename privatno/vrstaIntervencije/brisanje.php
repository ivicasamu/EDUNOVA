<?php 
	...
	if(isset($_GET["sifra"])){
		$izraz = $veza->prepare("select a.sifra, a.datum_dojave from intervencija a inner join vrsta_intervencije b on a.vrsta_intervencije=b.sifra where a.vrsta_intervencije=:sifra");
  			...
  			<div class="large-6 medium-12 small-12 columns large-centered">
  				...
  				<ul>
  					<?php foreach ($entiteti as $intervencija) {
						  echo "<li>Intervenciji broj: " . $intervencija->sifra. ", od datuma: " . date("Y-m-d",strtotime($intervencija->datum_dojave)) . "</li>"; 
					  } ?>
  				</ul>
