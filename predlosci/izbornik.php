    ...
    <?php endif; ?>		
   	<?php if(isset($_SESSION["logiran"])):  ?>
      	...
      	<?php if(isset($_SESSION["logiran"]) && $_SESSION["logiran"]->uloga==="Administrator"): ?>
      		<li>
      			<a href="<?php echo $putanjaAPP ?>privatno/operater/operater.php">
      				<i title="Operateri" class="step fi-widget size-60"></i>
      				<span class="hide-for-small-only"> Operateri</span>
      			</a>
      		</li>
      	<?php endif; ?>
      	<li>
